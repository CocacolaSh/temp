...
(function($){
    $.fn.scratchie = function(options) {
        // default options
        var settings = {
        	cursor: '/plugins/lottery/images/demo/coin.gif', // mouse cursor image
            ...
            img : '/plugins/lottery/images/demo/prize.jpg', // target (prize) img source
            prizeName:"Î´ÖÐ½±",
            ...
            fillImg : '/plugins/lottery/images/demo/overlay.jpg', // scratchcard overlay image
            fillX : 10, // width of overlay blocks
            fillY : 10, // height of overlay blocks
        ...
        this.each(function (){
        	...
        	// create cursor div
        	t.find("div").after('<div id="cursor" style="cursor:none;width:' + settings.cursorWidth + 'px;height:' + settings.cursorHeight + 'px;position:fixed;display:none;top:0;left:0;z-index:10000;background:url(' + settings.cursor + ') top left no-repeat;"></div>');
