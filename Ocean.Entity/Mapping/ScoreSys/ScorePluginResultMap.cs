...
namespace Ocean.Entity
{
    ...
    /// 实体类-数据表映射——
    /// </summary>    
	public partial class ScorePluginResultMap : EntityTypeConfiguration<ScorePluginResult>
    {
        /// <summary>
        /// 实体类-数据表映射构造函数——ScorePluginResult
        /// </summary>
        public ScorePluginResultMap()
        {
			// 主键
            this.HasKey(p => p.Id);
			...
			// 表 & 列映射
            this.ToTable("ScorePluginResult");
			//属性
