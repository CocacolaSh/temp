...
namespace Ocean.Services
{
    ...
    {
        #region Constants
        private const string SETTINGS_ALL_KEY = "Ocean.setting.all";
        #endregion
        ...
        public virtual void SetSetting<T>(string key, T value, bool clearCache = true)
        {
            ...
            string valueStr = CommonHelper.GetOceanCustomTypeConverter(typeof(T)).ConvertToInvariantString(value);
            if (settings.ContainsKey(key))
            {
                //update
