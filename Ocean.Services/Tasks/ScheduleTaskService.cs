...
namespace Ocean.Services.Tasks
{
    /// <summary>
    /// Task service
    /// </summary>
    public partial class ScheduleTaskService : ServiceBase<ScheduleTask>, IScheduleTaskService
    {
        #region Ctor

        public ScheduleTaskService(IRepository<ScheduleTask> taskRepository, IDbContext context)
            : base(taskRepository, context)
        {
        }
