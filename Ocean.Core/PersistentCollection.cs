...
namespace Ocean.Core
{
         ...
         where T : class
    {
        ...
        /// Return true if it should be added, false if it should not be added.
        /// </summary>
        ...
        /// it. Return true if it should be removed, false if it should not be removed.
        /// </summary>
