...
{
    /// <summary>
    /// A class that finds types needed by Ocean by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether Ocean should iterate assemblies in the app domain when loading Ocean types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Ocean assemblies arn't investigated (e.g. by not including something like "^Ocean|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the Ocean factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into Ocean.</returns>
