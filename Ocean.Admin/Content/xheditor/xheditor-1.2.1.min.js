...
function Editor(id, opts) {
    var options = { skin: "nostyle", tools: "Fontface,Blocktag,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,|,Align,List,Outdent,Indent,Table,|,Link,Img,|,Source", upMultiple: 20, upImgUrl: "/MpMaterial/Uploadxh?﻿﻿﻿﻿﻿﻿﻿﻿immediate=1" };
    opts = opts || {};
    $.extend(options, opts || {});
        $('#' + id).xheditor({
            plugins:xheditorPlugin,
            skin: options.skin,
            tools: options.tools,
            upMultiple: options.upMultiple,
            upImgUrl: options.upImgUrl,
            afterGetSource: options.afterGetSource || function () { }
        });
}