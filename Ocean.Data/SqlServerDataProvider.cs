...
namespace Ocean.Data
{
    public class SqlServerDataProvider : BaseEfDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have oceanCommerce 2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<OceanObjectContext>(tablesToValidate, customCommands.ToArray());
        ...
        public override DbTransaction GetTransaction(DbConnection conn)
        {
            return null;
        }
    }
